...
namespace SV21T1020323.DataLayers
{
    ...
    {
        /// <summary>
        /// Tìm kiêm và lấy danh sách đơn hàng dưới dạng phân trang
        /// </summary>
        ...
        /// <returns></returns>
        List<Order> List(int page = 1, int pageSize = 0, int status = 0, DateTime? fromTime = null, DateTime? toTime = null, string searchValue = "");
       /// <summary>
